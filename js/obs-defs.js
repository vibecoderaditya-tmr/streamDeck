...
(function (global) {
  ...
  const ACTIONS = [
    ...
    { value: "cut_to_scene", label: "Cut To Scene (ignores current transition)", hasParam: "scene", req: "LOGIC:cut_to_scene" },
    { value: "transition_to_scene", label: "Transition To Scene (pick type)", hasParam: "scene,transition", req: "LOGIC:transition_to_scene" },
  ...
  const PRESETS = [
    ...
    { cat: "Switching", label: "Quick Cut", icon: "✂️", actions: [{ type: "cut_to_scene", params: { scene: "" } }], feedbacks: [{ type: "scene_in_program", params: { scene: "" }, activeColor: "green" }] },
    { cat: "Switching", label: "Quick Transition", icon: "⚡", actions: [{ type: "transition_to_scene", params: { scene: "", transition: "Cut" } }], feedbacks: [{ type: "scene_in_program", params: { scene: "" }, activeColor: "green" }] },
